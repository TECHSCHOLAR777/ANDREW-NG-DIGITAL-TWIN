...
async def lifespan(app: FastAPI):
    ...
    if not db_url:
        ...
        # Normalize protocol prefix for the asyncpg driver
        ...
        if not connected:
            logger.error("CRITICAL: Failed to connect to the database after %d attempts. Running in degraded state.", max_retries)
