  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col">
        {/* Skip link: first focusable element, visible only on focus. Lets
            keyboard users bypass the navigation bar and reach content directly. */}
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[9999] focus:rounded-lg focus:bg-[var(--brand)] focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-[var(--brand-text)] focus:shadow-lg"
        >
